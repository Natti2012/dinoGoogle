...
var mejoresPuntajes = []
var current_user
let playerCurrent = JSON.parse(window.localStorage.getItem("player"));
...
function IsCollision(a, b, paddingTop, paddingRight, paddingBottom, paddingLeft) {
    ...
    return !(
        ...
        (aRect.top + paddingTop > (bRect.top + bRect.height)) || ((aRect.left + aRect.width - paddingRight) < bRect.left) || (aRect.left + paddingLeft > (bRect.left + bRect.width))
    );
}
function GameOver() {
    Estrellarse();
    ...
    scoreCurrent = JSON.parse(window.localStorage.getItem("score"));
    postScore(playerCurrent, scoreCurrent)
...
function currentUser() {
    ...
    if (playerCurrent) {
        jugador.innerText = `Hola  ${playerCurrent}... A jugar!!`
        current_user.appendChild(jugador)
